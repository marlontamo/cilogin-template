      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href=""><i class="fa fa-circle-o"></i>Add Product</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> show all stores</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> show my store</a></li>
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('assets/Admin_lte/bower_components/jquery-knob/dist/jquery.knob.min.js');?>">
